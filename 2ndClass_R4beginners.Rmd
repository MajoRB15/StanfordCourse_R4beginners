...
|   **Function**   |           **Use**            |
|--------------|----------------------------------|
|  `na.omit()`| `For storing any type of number values` |
|  `subset()`| `For integer numbers` |
...
|  `dim()`   |    ` Obatining the dimensions of data`                       
...
* Print the names of the 3 Islands the data set has: "Adelie Gentoo Chinstrap"
...
#Names of islands in the data set
